package app.victor.sentinela.imbituba.printer;
...
public class BluetoothDeviceActivity extends Activity{
    ...
    private class DeviceNode {   
        ...
        /*construtor da classe DeviceNode*/
    ...
    public class DeviceAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View v = convertView;
            if (v == null) {
                LayoutInflater vi = LayoutInflater.from(BluetoothDeviceActivity.this);
                v = vi.inflate(R.layout.bluetooth_node, null);
            }
